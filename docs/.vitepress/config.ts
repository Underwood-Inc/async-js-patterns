      ...
      sidebar: {
        ...
        '/typescript/': [
          {
            ...
            items: [
              { text: 'Utility Types', link: '/typescript/utility-types' },
              {
                ...
                link: '/typescript/array-operations',
              },
              ...
              },
              {
                ...
                link: '/typescript/string-utilities',
              },
              {
          ...
          },
          {
            ...
            items: [
              { text: 'Immutable State', link: '/typescript/immutable-state' },
              {
                ...
                link: '/typescript/observable-state',
              },
              {
                text: 'State Management',
                link: '/typescript/state-management',
              },
            ],
          },
        ],
        ...
        '/examples/': [
          ...
          },
          {
            text: 'UI Components',
            items: [
              { text: 'Tooltip System', link: '/examples/tooltip-system' },
            ],
          },
        ],
        '/styling/': [
